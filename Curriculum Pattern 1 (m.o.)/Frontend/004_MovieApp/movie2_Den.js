...
function getAllMovies2() {
    ...
    for(let el of movies) {
        let card = `<div class="card" style="width: 18rem;">
                        ...
                        <li class="list-group-item">${el.language}</li>
                        <li class="list-group-item">${el.rating}</li>
                        <li class="list-group-item">${el.premiered}</li>
                        <li class="list-group-item">${el.country}</li>
                        <li class="list-group-item">
                            <span>${el.genres.length>0 ? el.genres[0] : ''}</span>
                            <span>${el.genres.length>1 ? el.genres[1] : ''}</span>
                            <span>${el.genres.length>2 ? el.genres[2] : ''}</span>
                        </li>
                        </ul>
                        <div class="card-body">
                        <a href="${el.url}" class="card-link">${el.url}</a>
                        </div>
                    </div>
        `;
