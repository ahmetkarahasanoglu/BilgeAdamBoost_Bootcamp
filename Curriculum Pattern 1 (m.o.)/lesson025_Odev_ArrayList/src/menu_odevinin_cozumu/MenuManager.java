...
public class MenuManager {
	...
	// CONSTRUCTOR:
	public MenuManager() {
		this.icecekler = new ArrayList<>(Arrays.asList(EIcecekler.values())); // Burda array'i arrayList'e çeviriyoruz.  Here, 'Arrays.asList()' creates an ArrayList from the enum constants.
	...
	public Enum menuBelirle2(ArrayList<Enum> list) {
		...
		list.remove(index); // Kullanılan yemeği siliyoruz, tekrar başka menüde çıkmaması için.
		return value;
	}
